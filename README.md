...
OBJECTIVE:
This project is work portfolio for maulik aims to develop a Tic Tac Toe game using react. It mainly consists of developing and implementing a computer program that plays Tic Tac Toe against another player.
